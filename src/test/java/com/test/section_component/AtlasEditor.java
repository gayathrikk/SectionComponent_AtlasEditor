...
public class AtlasEditor {
	...
	public void viewerPage() throws InterruptedException {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//tbody/tr[9]/td[3]" ))).click();
	    	 ...
	    	 wait.until(ExpectedConditions.numberOfWindowsToBe(2));
			  ...
			  wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//span[text()='1096'])[1]"))).click();
	  ...
	  public void atlas() throws InterruptedException
			  ...
			  WebElement atlasIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='Atlas Editor']")));
			if (atlasIcon != null && atlasIcon.isDisplayed()) {
			atlasIcon.click();
			    System.out.println("Atlas editor icon is clicked successfully");
			} else {
			...
			editMenu.click();
			    System.out.println("Edit menu icon is clicked successfully");
			} else {
	...
	public void section_component() throws InterruptedException
			...
			speciesButton.click();
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='Mouse']"))).click();
			...
			organName.click();
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='MTB15']"))).click();
			...
			section.click();
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='126']"))).click();
			...
			String[] expectedFileName = {"19 | NISSL | 126"};  
